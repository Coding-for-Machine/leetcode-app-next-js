        ...
        <div className="p-4 h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="space-y-2 mb-6">
              ...
              <Link href="/masalalar" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
                <i className="fas fa-list-ol mr-2"></i>Masalalar
              </Link>
              <Link href="/tanlovlar" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            ...
            <div className="px-3 py-4 border-t border-slate-200">
              ...
              {isAuthenticated ? (
                ...
                <div className="space-y-2">
                  <Link href="/kirish" className="w-full block bg-indigo-50 text-indigo-600 px-4 py-2 rounded-lg font-medium text-center">
                    Kirish
                  </Link>
                  <Link href="/royxatdan-otish" className="w-full block bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 py-2 rounded-lg font-medium shadow-sm text-center">
                    Ro'yxatdan o'tish
                  </Link>
                </div>
              )}
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden lg:flex space-x-6">
                ...
                <Link href="/masalalar" className="px-1 py-2 text-sm font-medium flex items-center text-slate-700 hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-600">
                  <i className="fas fa-list-ol mr-2"></i>Masalalar
                </Link>
                <Link href="/tanlovlar" className="px-1 py-2 text-sm font-medium flex items-center text-slate-700 hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-600">
                  <i className="fas fa-trophy mr-2"></i>Tanlovlar
                </Link>
            ...
            <div className="flex items-center space-x-3">
              ...
              {isAuthenticated ? (
                ...
                <div className="hidden sm:flex space-x-2">
                  <Link href="/kirish" className="px-3 py-1.5 rounded-full text-sm font-medium text-slate-700 hover:text-indigo-600">
                    Kirish
                  </Link>
                  <Link href="/royxatdan-otish" className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-3 py-1.5 rounded-full text-sm font-medium shadow-sm">
                    Ro'yxatdan o'tish
                  </Link>
                </div>
              )}
